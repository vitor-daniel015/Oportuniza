  ...
  return (
    <main className="min-h-screen bg-[#f4f6f7]">
      <section className="flex min-h-screen w-full flex-col overflow-hidden bg-[#f4f6f7] lg:flex-row">
        ...
        <aside className="relative flex min-h-[310px] flex-col overflow-hidden bg-[#215985] px-7 py-7 text-white lg:order-2 lg:min-h-full lg:w-[47%] lg:px-12 lg:py-10 lg:[clip-path:polygon(0_0,100%_0,100%_100%,18%_100%)]">
        ...
        <div className="relative z-10 -mt-7 flex flex-1 items-center justify-center rounded-t-[32px] bg-[#f4f6f7] px-6 py-10 lg:order-1 lg:mt-0 lg:rounded-none lg:px-16">
