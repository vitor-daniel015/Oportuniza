...
export function ContactInfoCard({ icon: Icon, title, description }: ContactInfoCardProps) {
  return (
    <div className="flex flex-col items-center">
      <div className="mb-3 flex h-16 w-16 -translate-y-8 items-center justify-center rounded-full bg-brand-blue-depth shadow-lg sm:mb-4 sm:-translate-y-0 sm:h-24 sm:w-24">
