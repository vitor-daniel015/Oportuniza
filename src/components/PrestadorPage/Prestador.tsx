...
import { PrestadorPublico ,getPrestadoresPublicos } from "../../service/PrestadoresPublicosService";
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-[50vh]">
        <p className="text-lg font-medium text-slate-600">Carregando profissionais...</p>
      </div>
    );
  }
  return (
